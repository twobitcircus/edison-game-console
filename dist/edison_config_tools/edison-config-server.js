...
http.createServer(requestHandler).listen(80);  // Standard HTTP Web Server

///////////////////////////////////////////////////////
// Customizations to Intel Edison boot node app
///////////////////////////////////////////////////////
http.createServer(requestHandler).listen(843); // crossdomain.xml WebSocket Policy Server (port 843)
// Spawn the other node.js app
var fork = require('child_process').fork;
var child = fork('/home/root/node_app_slot/app', [], {
  stdio: 'pipe'
});
